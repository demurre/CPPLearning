...
public class MainManual {
    public static void main(String[] args) {
        ...
        System.out.print("Enter a in the format double: ");
        double a = scanner.nextDouble();
        System.out.print("Enter b in the format double: ");
        double b = scanner.nextDouble();
        System.out.print("Enter k in the format double: ");
        double k = scanner.nextDouble();
        System.out.print("Enter n in the format double: ");
        double n = scanner.nextDouble();
        System.out.print("Enter e in the format double: ");
